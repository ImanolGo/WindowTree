...
void GuiTheme::setup()
{
    ...
    style->Colors[ImGuiCol_TextDisabled] = ImVec4(col_main_text, 1.0f);
    style->Colors[ImGuiCol_WindowBg] = ImVec4(col_win_backg, 1.00f);
    style->Colors[ImGuiCol_ChildWindowBg] = ImVec4(col_main_area, 1.0f);
    ...
    style->Colors[ImGuiCol_FrameBgHovered] = ImVec4(col_main_head, 1.0f);
    style->Colors[ImGuiCol_FrameBgActive] = ImVec4(col_main_head, 1.00f);
    style->Colors[ImGuiCol_TitleBg] = ImVec4(col_main_area, 1.00f);
    style->Colors[ImGuiCol_TitleBgCollapsed] = ImVec4(col_main_area, 1.0f);
    style->Colors[ImGuiCol_TitleBgActive] = ImVec4(col_main_head, 1.00f);
    style->Colors[ImGuiCol_MenuBarBg] = ImVec4(col_main_area, 1.0f);
    style->Colors[ImGuiCol_ScrollbarBg] = ImVec4(col_main_area, 1.00f);
    style->Colors[ImGuiCol_ScrollbarGrab] = ImVec4(col_win_popup, 1.01f);
    style->Colors[ImGuiCol_ScrollbarGrabHovered] = ImVec4(col_main_head, 1.0f);
    style->Colors[ImGuiCol_ScrollbarGrabActive] = ImVec4(col_main_head, 1.00f);
    style->Colors[ImGuiCol_CheckMark] = ImVec4(col_main_head, 1.0f);
    style->Colors[ImGuiCol_SliderGrab] = ImVec4(col_win_popup, 1.0f);
    style->Colors[ImGuiCol_SliderGrabActive] = ImVec4(col_main_head, 1.00f);
    style->Colors[ImGuiCol_Button] = ImVec4(col_win_popup, 1.0f);
    style->Colors[ImGuiCol_ButtonHovered] = ImVec4(col_main_head, 1.06f);
    style->Colors[ImGuiCol_ButtonActive] = ImVec4(col_main_head, 1.00f);
    style->Colors[ImGuiCol_Header] = ImVec4(col_main_head, 1.0f);
    style->Colors[ImGuiCol_HeaderHovered] = ImVec4(col_main_head, 1.0f);
    style->Colors[ImGuiCol_HeaderActive] = ImVec4(col_main_head, 1.00f);
    style->Colors[ImGuiCol_Column] = ImVec4(col_win_popup, 1.0f);
    style->Colors[ImGuiCol_ColumnHovered] = ImVec4(col_main_head, 1.0f);
    style->Colors[ImGuiCol_ColumnActive] = ImVec4(col_main_head, 1.00f);
    style->Colors[ImGuiCol_ResizeGrip] = ImVec4(col_win_popup, 0.04f);
    style->Colors[ImGuiCol_ResizeGripHovered] = ImVec4(col_main_head, 1.0f);
    style->Colors[ImGuiCol_ResizeGripActive] = ImVec4(col_main_head, 1.00f);
    style->Colors[ImGuiCol_PlotLines] = ImVec4(col_main_text, 1.0f);
    style->Colors[ImGuiCol_PlotLinesHovered] = ImVec4(col_main_head, 1.00f);
    style->Colors[ImGuiCol_PlotHistogram] = ImVec4(col_main_text, 1.0f);
    style->Colors[ImGuiCol_PlotHistogramHovered] = ImVec4(col_main_head, 1.00f);
    style->Colors[ImGuiCol_TextSelectedBg] = ImVec4(col_main_head, 1.0f);
    style->Colors[ImGuiCol_PopupBg] = ImVec4(col_win_backg, 1.0f);
    style->Colors[ImGuiCol_ModalWindowDarkening] = ImVec4(col_main_area, 1.0f);
